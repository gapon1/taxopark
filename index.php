            ...
            <div id="formavt">
                <form class="form-inline"  action="mysql_insert_car.php" method="post"  name="form">
                    <div class="form-group">
                        ...
                        <input name="name" type="text"   class="form-control" id="exampleInputName2" placeholder="Mersedes">
                    </div>
                    <div class="form-group">
            ...
            <div id="formrosp">
                <form class="form-inline" action="mysql_insert_rospis.php" method="post"  name="form">
                    ...
                    <div class="form-group">
                        ...
                        <input name="закінчив" type="datetime" class="form-control"    placeholder="Time 2016-06-01 18:00:00 ">
                    </div>
